...
class DQN():
    ...
    def conv2d(self, x, W):
        ...
        # stride第一個和最後一個元素一定要為1，中間兩個分別是x和y軸的跨度，此處設為1
        # SAME 抽取時外面有填充，抽取大小是一樣的
    ...
    def create_updating_method(self):
        ...
        # 生成的Q_value實際上是一個action大小的list,action_input是一個one-hot向量,
        # 兩者相乘實際上是取出了執行操作的Q值進行單獨更新
        # this is the lost
        ...
        with tf.name_scope('train_loss'):
            ...
            self.optimizer = tf.train.AdamOptimizer(0.001).minimize(self.cost)#原為0.001
