...
if __name__ == '__main__':
    ...
    for episode in range(EPISODES):
        ...
        while True:
            ...
            #if len(agent.replay_buffer) > big_BATCH_SIZE: 被註解掉，要測試
                #num_step += 1 被註解掉，要測試
                # save loss graph
                # print('train')
                #agent.Train_Network(big_BATCH_SIZE, num_step)被註解掉，要測試
            #if target_step % UPDATE_STEP == 0:被註解掉，要測試
                #agent.Update_Target_Network()被註解掉，要測試
